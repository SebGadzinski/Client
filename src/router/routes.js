...
const layout = {
  ...
  children: [
    ...
    { path: 'work/template/', component: () => import('pages/work/template/WorkTemplateIndexPage.vue'), },
    { path: 'work/template/:workTemplateId', component: () => import('pages/work/template/WorkTemplatePage.vue'), },
    { path: 'work/template/edit', component: () => import('pages/work/template/WorkTemplateEditorPage.vue'), },
    ...
    { path: 'admin/vmStatusReport', component: () => import('pages/admin/VMStatusReportPage.vue'), },
    { path: 'admin/work-status', component: () => import('pages/admin/WorkStatusPage.vue'), },
